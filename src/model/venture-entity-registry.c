...
venture_entity_registry_register_builtins(VentureEntityRegistry *self)
{
	...
	static GType (*const builtins[]) (void) = {
		...
		venture_stripe_payment_link_get_type,
		...
		venture_ocr_job_get_type,
		venture_ocr_batch_get_type,
		...
		venture_sales_territory_get_type,
		venture_sales_quota_get_type,
		venture_sales_credit_get_type,
		venture_sales_assignment_get_type,
