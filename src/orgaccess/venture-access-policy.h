 ...
 * @error: (out) (optional): return location for refusal
 *
 ...
 *
 * Returns: (transfer full) (element-type VentureEntity) (nullable): authorized rows
 */
 ...
 * @next: (scope call) (closure next_data): synchronous next middleware
 * @next_data: (nullable): middleware data
 *
 ...
 * @staged_out: (out): whether a confirmation was created
 * @error: (out) (optional): refusal
 *
 ...
 * @params: (element-type utf8 utf8): route parameters
 *
