...
static const VentureFieldDecl lead_fields[] = {
	...
	VENTURE_FIELD("owner", "Owner", NULL, VENTURE_FIELD_KIND_STRING, VENTURE_COLUMN_FLAG_INDEXED | VENTURE_COLUMN_FLAG_ASSIGNED_USERNAME),
	VENTURE_FIELD_REF("owner-user-id", "Owner account", "Resolved from the assigned username", "user", VENTURE_COLUMN_FLAG_NONE),
