...
INSERT INTO venture_supplier_portal_upgrade_guard SELECT COUNT(*) FROM information_schema.tables
 WHERE table_schema = current_schema() AND table_type = 'BASE TABLE'
 AND table_name = 'supplier_portal_accesses';
...
INSERT INTO venture_custom_fields_upgrade_guard SELECT COUNT(*) FROM information_schema.tables
 WHERE table_schema = current_schema() AND table_type = 'BASE TABLE'
 AND table_name IN ('accounting_custom_fields', 'accounting_layouts', 'custom_field_values');
