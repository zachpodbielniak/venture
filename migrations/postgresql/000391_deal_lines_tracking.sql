...
INSERT INTO venture_deal_lines_upgrade_guard SELECT COUNT(*) FROM information_schema.tables
 WHERE table_schema = current_schema() AND table_type = 'BASE TABLE'
 AND table_name IN ('deal_lines');
...
INSERT INTO venture_sequence_tracking_upgrade_guard SELECT COUNT(*) FROM information_schema.tables
 WHERE table_schema = current_schema() AND table_type = 'BASE TABLE'
 AND table_name IN ('sequence_links', 'sequence_tracking_events');
