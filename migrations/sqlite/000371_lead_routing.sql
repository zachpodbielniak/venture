...
INSERT INTO venture_lead_routing_upgrade_guard SELECT COUNT(*) FROM sqlite_master
 WHERE type = 'table' AND name IN ('lead_routing_rules', 'lead_scoring_rules', 'lead_score_histories');
