...
INSERT INTO venture_assets_upgrade_guard SELECT COUNT(*) FROM sqlite_master
 WHERE type = 'table' AND name IN ('fixed_assets', 'depreciation_entries', 'deferrals', 'deferral_entries');
